...
std::string base64ToHex(const std::vector<unsigned char>& bytes)
{
  ...
  {
    throw OpenSSLException(internal::OpenSSLUtils::getOpenSSLErrorMessage("OPENSSL_buf2hexstr_ex"));
  }
...
std::vector<unsigned char> hexToBase64(const std::string& inputString)
{
  ...
  {
    throw OpenSSLException(internal::OpenSSLUtils::getOpenSSLErrorMessage("OPENSSL_hexstr2buf_ex"));
  }
