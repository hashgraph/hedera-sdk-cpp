...
const std::vector<std::byte> ASN1_CPUBK_PREFIX_BYTES = {
    std::byte(0x30), std::byte(0x36), std::byte(0x30), std::byte(0x10),
    std::byte(0x06), std::byte(0x07), std::byte(0x2A), std::byte(0x86),
    std::byte(0x48), std::byte(0xCE), std::byte(0x3D), std::byte(0x02),
    std::byte(0x01), std::byte(0x06), std::byte(0x05), std::byte(0x2B),
    std::byte(0x81), std::byte(0x04), std::byte(0x00), std::byte(0x0A),
    std::byte(0x03), std::byte(0x22)};
...
const std::vector<std::byte> ASN1_UPUBK_PREFIX_BYTES = {
    std::byte(0x30), std::byte(0x56), std::byte(0x30), std::byte(0x10),
    std::byte(0x06), std::byte(0x07), std::byte(0x2A), std::byte(0x86),
    std::byte(0x48), std::byte(0xCE), std::byte(0x3D), std::byte(0x02),
    std::byte(0x01), std::byte(0x06), std::byte(0x05), std::byte(0x2B),
    std::byte(0x81), std::byte(0x04), std::byte(0x00), std::byte(0x0A),
    std::byte(0x03), std::byte(0x42)};
