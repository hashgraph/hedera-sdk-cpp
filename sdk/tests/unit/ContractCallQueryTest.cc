...
class ContractCallQueryTest : public ::testing::Test
{
protected:
...
//-----
TEST_F(ContractCallQueryTest, GetSetContractId)
{
  // Given
...
//-----
TEST_F(ContractCallQueryTest, GetSetGas)
{
  // Given
  ContractCallQuery query;
...
//-----
TEST_F(ContractCallQueryTest, GetSetFunctionParameters)
{
  // Given
  ContractCallQuery query;
...
//-----
TEST_F(ContractCallQueryTest, GetSetSenderAccountId)
{
  // Given
  ContractCallQuery query;
