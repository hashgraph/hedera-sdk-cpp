...
class LedgerIdTest : public ::testing::Test
{
protected:
...
//-----
TEST_F(LedgerIdTest, MainnetLedgerIdInitialization)
{
  // Given / When / Then
...
//-----
TEST_F(LedgerIdTest, TestnetLedgerIdInitialization)
{
  // Given / When / Then
...
//-----
TEST_F(LedgerIdTest, PreviewnetLedgerIdInitialization)
{
  // Given / When / Then
...
//-----
TEST_F(LedgerIdTest, ConstructLedgerIdWithMainnetBytes)
{
  // Given / When
...
//-----
TEST_F(LedgerIdTest, ConstructLedgerIdWithTestnetBytes)
{
  // Given / When
...
//-----
TEST_F(LedgerIdTest, ConstructLedgerIdWithPreviewnetBytes)
{
  // Given / When
...
//-----
TEST_F(LedgerIdTest, ConstructLedgerIdWithBytes)
{
  // Given / When
...
//-----
TEST_F(LedgerIdTest, FromString)
{
  // Given / When
