 ...
 *
 */
#ifndef HEDERA_SDK_CPP_TOKEN_CANCEL_AIRDROP_TRANSACTION_H_
#define HEDERA_SDK_CPP_TOKEN_CANCEL_AIRDROP_TRANSACTION_H_
...
#endif // HEDERA_SDK_CPP_TOKEN_CANCEL_AIRDROP_TRANSACTION_H_