...
namespace Hedera {
//-----
const std::unordered_map<proto::HederaFunctionality, RequestType>
    gProtobufHederaFunctionalityToRequestType = {
        {proto::HederaFunctionality::NONE, RequestType::NONE},
        {proto::HederaFunctionality::CryptoTransfer,
        ...
        {proto::HederaFunctionality::CryptoAddLiveHash,
         RequestType::CRYPTO_ADD_LIVE_HASH},
        {proto::HederaFunctionality::CryptoDeleteLiveHash,
         RequestType::CRYPTO_DELETE_LIVE_HASH},
        {proto::HederaFunctionality::ContractCall, RequestType::CONTRACT_CALL},
        {proto::HederaFunctionality::ContractCreate,
         RequestType::CONTRACT_CREATE},
        {proto::HederaFunctionality::ContractUpdate,
        ...
        {proto::HederaFunctionality::CryptoGetAccountBalance,
         RequestType::CRYPTO_GET_ACCOUNT_BALANCE},
        {proto::HederaFunctionality::CryptoGetAccountRecords,
         RequestType::CRYPTO_GET_ACCOUNT_RECORDS},
        {proto::HederaFunctionality::CryptoGetInfo,
         RequestType::CRYPTO_GET_INFO},
        {proto::HederaFunctionality::ContractCallLocal,
         RequestType::CONTRACT_CALL_LOCAL},
        {proto::HederaFunctionality::ContractGetInfo,
         RequestType::CONTRACT_GET_INFO},
        {proto::HederaFunctionality::ContractGetBytecode,
         RequestType::CONTRACT_GET_BYTECODE},
        {proto::HederaFunctionality::GetBySolidityID,
         RequestType::GET_BY_SOLIDITY_ID},
        {proto::HederaFunctionality::GetByKey, RequestType::GET_BY_KEY},
        {proto::HederaFunctionality::CryptoGetLiveHash,
         RequestType::CRYPTO_GET_LIVE_HASH},
        {proto::HederaFunctionality::CryptoGetStakers,
         RequestType::CRYPTO_GET_STAKERS},
        {proto::HederaFunctionality::FileGetContents,
         RequestType::FILE_GET_CONTENTS},
        {proto::HederaFunctionality::FileGetInfo, RequestType::FILE_GET_INFO},
        {proto::HederaFunctionality::TransactionGetRecord,
         RequestType::TRANSACTION_GET_RECORD},
        {proto::HederaFunctionality::ContractGetRecords,
        ...
        {proto::HederaFunctionality::SystemUndelete,
         RequestType::SYSTEM_UNDELETE},
        {proto::HederaFunctionality::ContractDelete,
         RequestType::CONTRACT_DELETE},
        {proto::HederaFunctionality::Freeze, RequestType::FREEZE},
        {proto::HederaFunctionality::CreateTransactionRecord,
         RequestType::CREATE_TRANSACTION_RECORD},
        {proto::HederaFunctionality::CryptoAccountAutoRenew,
         RequestType::CRYPTO_ACCOUNT_AUTO_RENEW},
        {proto::HederaFunctionality::ContractAutoRenew,
         RequestType::CONTRACT_AUTO_RENEW},
        {proto::HederaFunctionality::GetVersionInfo,
         RequestType::GET_VERSION_INFO},
        {proto::HederaFunctionality::TransactionGetReceipt,
         RequestType::TRANSACTION_GET_RECEIPT},
        {proto::HederaFunctionality::ConsensusCreateTopic,
         RequestType::CONSENSUS_CREATE_TOPIC},
        {proto::HederaFunctionality::ConsensusUpdateTopic,
         RequestType::CONSENSUS_UPDATE_TOPIC},
        {proto::HederaFunctionality::ConsensusDeleteTopic,
         RequestType::CONSENSUS_DELETE_TOPIC},
        {proto::HederaFunctionality::ConsensusGetTopicInfo,
         RequestType::CONSENSUS_GET_TOPIC_INFO},
        {proto::HederaFunctionality::ConsensusSubmitMessage,
         RequestType::CONSENSUS_SUBMIT_MESSAGE},
        {proto::HederaFunctionality::UncheckedSubmit,
        ...
        {proto::HederaFunctionality::TokenFreezeAccount,
         RequestType::TOKEN_FREEZE_ACCOUNT},
        {proto::HederaFunctionality::TokenUnfreezeAccount,
         RequestType::TOKEN_UNFREEZE_ACCOUNT},
        {proto::HederaFunctionality::TokenGrantKycToAccount,
         RequestType::TOKEN_GRANT_KYC_TO_ACCOUNT},
        {proto::HederaFunctionality::TokenRevokeKycFromAccount,
        ...
        {proto::HederaFunctionality::TokenAccountWipe,
         RequestType::TOKEN_ACCOUNT_WIPE},
        {proto::HederaFunctionality::TokenAssociateToAccount,
         RequestType::TOKEN_ASSOCIATE_TO_ACCOUNT},
        {proto::HederaFunctionality::TokenDissociateFromAccount,
         RequestType::TOKEN_DISSOCIATE_FROM_ACCOUNT},
        {proto::HederaFunctionality::ScheduleCreate,
         RequestType::SCHEDULE_CREATE},
        {proto::HederaFunctionality::ScheduleDelete,
         RequestType::SCHEDULE_DELETE},
        {proto::HederaFunctionality::ScheduleSign, RequestType::SCHEDULE_SIGN},
        {proto::HederaFunctionality::ScheduleGetInfo,
         RequestType::SCHEDULE_GET_INFO},
        {proto::HederaFunctionality::TokenGetAccountNftInfos,
         RequestType::TOKEN_GET_ACCOUNT_NFT_INFOS},
        {proto::HederaFunctionality::TokenGetNftInfo,
         RequestType::TOKEN_GET_NFT_INFO},
        {proto::HederaFunctionality::TokenGetNftInfos,
         RequestType::TOKEN_GET_NFT_INFOS},
        {proto::HederaFunctionality::TokenFeeScheduleUpdate,
         RequestType::TOKEN_FEE_SCHEDULE_UPDATE},
        {proto::HederaFunctionality::NetworkGetExecutionTime,
        ...
        {proto::HederaFunctionality::CryptoApproveAllowance,
         RequestType::CRYPTO_APPROVE_ALLOWANCE},
        {proto::HederaFunctionality::CryptoDeleteAllowance,
         RequestType::CRYPTO_DELETE_ALLOWANCE},
        {proto::HederaFunctionality::GetAccountDetails,
         RequestType::GET_ACCOUNT_DETAILS},
        {proto::HederaFunctionality::EthereumTransaction,
         RequestType::ETHEREUM_TRANSACTION},
        {proto::HederaFunctionality::NodeStakeUpdate,
         RequestType::NODE_STAKE_UPDATE},
        {proto::HederaFunctionality::UtilPrng, RequestType::UTIL_PRNG},
        {proto::HederaFunctionality::TokenUpdateNfts,
         RequestType::TOKEN_UPDATE_NFTS},
};

//-----
const std::unordered_map<RequestType, proto::HederaFunctionality>
    gRequestTypeToProtobufHederaFunctionality = {
